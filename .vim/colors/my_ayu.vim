...
let s:palette.line      = {'dark': "#151A1E",  'light': "#F3F3F3",  'mirage': "#243338"}
let s:palette.selection = {'dark': "#253340",  'light': "#F0EEE4",  'mirage': "#343F5C"}
let s:palette.fg        = {'dark': "#E6E1CF",  'light': "#5C6773",  'mirage': "#D9D7CE"}
let s:palette.fg_idle   = {'dark': "#3E4B59",  'light': "#828C99",  'mirage': "#607080"}
let s:palette.search    = {'dark': "#725c73",  'light': "#725c73",  'mirage': "#725c73"}
...
exe "hi! Search"        .s:fg_fg          .s:bg_search      .s:fmt_none
exe "hi! IncSearch"     .s:fg_fg          .s:bg_search      .s:fmt_none
...
exe "hi! WarningMsg"    .s:fg_error       .s:bg_none        .s:fmt_none
  ...
  hi DiffAdd ctermbg=29 ctermfg=158 guibg=#345338 guifg=#c0c5b9
    hi DiffChange ctermbg=23 ctermfg=159 guibg=#525334 guifg=#b3c3cc
      hi DiffDelete cterm=NONE ctermbg=95 ctermfg=224 gui=NONE guibg=#533434 guifg=#ceb0b6
        hi DiffText cterm=NONE ctermbg=30 ctermfg=195 gui=NONE guibg=#74755c guifg=#c6c8d1
...
exe "hi! QuickFixLine"        .s:fg_none   .s:bg_selection        .s:fmt_none
"   qfFileName"
"   qfLineNr"
"   qfError"
...
" vim-lsp
" ---------
exe  "hi!  LspErrorText"        .s:fg_none  .s:bg_panel  .s:fmt_none
exe  "hi!  LspWarningText"      .s:fg_none  .s:bg_panel  .s:fmt_none
exe  "hi!  LspHintText"         .s:fg_none  .s:bg_panel  .s:fmt_none
exe  "hi!  LspInformationText"  .s:fg_none  .s:bg_panel  .s:fmt_none
exe  "hi!  LspCodeActionText"   .s:fg_none  .s:bg_panel  .s:fmt_none

exe  "hi!  LspErrorHighlight"        .s:fg_none  .s:bg_none  .s:fmt_none
exe  "hi!  LspWarningHighlight"      .s:fg_none  .s:bg_none  .s:fmt_none
exe  "hi!  LspHintHighlight"         .s:fg_none  .s:bg_none  .s:fmt_none
exe  "hi!  LspInformationHighlight"  .s:fg_none  .s:bg_none  .s:fmt_none
exe  "hi!  LspCodeActionHighlight"   .s:fg_none  .s:bg_none  .s:fmt_none
